...
export function getRewardInfo( {
  ...
  switch ( quest_reward_type ) {
    ...
    case 7:
      tt = [ quest_form_id ? `form_${ quest_form_id }` : '', `poke_${ quest_pokemon_id }` ];
      src = Icons.getPokemon( quest_pokemon_id, quest_form_id, 0, quest_gender_id, quest_costume_id, 0, !!quest_shiny );
      break;
